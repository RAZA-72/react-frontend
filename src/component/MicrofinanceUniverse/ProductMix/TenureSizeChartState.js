...
const TenureSizeChartstate = ({ data, title = "Tenure Size (%) - State", subtitle = "" }) => {
  ...
  // --------------------------
  // Transform + filter + reverse + DYNAMIC MAX
  // --------------------------
  const { series, categories, months, tenureRanges, dynamicMax } = useMemo(function () {
    var transformed = transformTenureAPIData(data);
    ...
    return {
      ...
      tenureRanges: transformed.tenureRanges,
