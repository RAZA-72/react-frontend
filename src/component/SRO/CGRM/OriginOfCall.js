...
const OriginOfCall = ({ data }) => {
  ...
  useEffect(() => {
    ...
    if (data && data.chart7 && Array.isArray(data.chart7)) {
      ...
      console.log("📊 chart7 data:", data.chart7);

      // Process API data
      const top10States = data.chart7.slice(0, 10);
      ...
      console.log("❌ No valid data in OriginOfCall");
  ...
  console.log("🎯 Rendering OriginOfCall chart with height:", chartHeight);
