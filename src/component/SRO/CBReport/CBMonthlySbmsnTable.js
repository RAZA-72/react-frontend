...
function CBMonthlySbmsnTable({ memberRecords, industryRecords, entityList, setCBDropdown, selectedEntity }) {
  ...
  //   "Value of active loan accounts (Rs Cr)",
  // ];
  const memberFields = [
  "Date of first fortnightly submission",
  "Date of second fortnightly/monthly submission",
  "Date of first weekly file submission",   // NEW
  "Date of second weekly file submission",  // NEW
  "Date of third weekly file submission",   // NEW
  "Date of fourth weekly file submission",  // NEW
  "Count of daily submission",
  "VID fill rate",
  "PAN fill rate",
  "Total monthly family income fill rate",
  ...
  //   "Number of active loan accounts (Cr)",
  //   "Value of active loan accounts (Rs Cr)"
  // ];

  const industryFields = [
  "Percentage of lenders submitted the first fortnightly file",
  "Lenders submitted first fortnightly file on or before time (i.e. 22nd of the respective month)",
  "Percentage of lenders submitted the second fortnightly file",
  "Lenders submitted second fortnightly/monthly file on or before time (i.e. 7th of the following month)",
  "Percentage of lenders submitted the first weekly file",   // NEW
  "Percentage of lenders submitted the second weekly file",  // NEW
  "Percentage of lenders submitted the third weekly file",   // NEW
  "Percentage of lenders submitted the fourth weekly file",  // NEW
  "Lenders submitted min 20 daily files in the month (%)",
  "VID fill rate",
  "PAN fill rate",
  "Total monthly family income fill rate",
        ...
        <Card style={{ marginBottom: "20px" }}>
          <CardActionArea>
            <CardContent>
              ...
              >
                {`Monthly Submission - ${memberRecords.filters.shortName || "Member"}`}
          ...
          <CardActionArea>
            <CardContent>
              <Typography
                ...
                style={{ textAlign: "left", fontSize: "18px", color: "#bd2f03" }}
              >
                {` Monthly Submission - ${industryRecords.filters.entity || "Universe"}`}
                <span style={{ float: "right" }}>
                  <Dropdown
                    keepOpen
                    open={open}
                    ...
                    menu={[
                      ...
                      <DropdownMenuItem key="pdf">
                        <Button
                          style={{ color: "#000" }}
                          endIcon={<PictureAsPdfIcon />}
                          onClick={() => downloadPdf("table-industry", "industry.pdf")}
                        >
                          PDF
                        </Button>
                      </DropdownMenuItem>
