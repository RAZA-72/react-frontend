...
// intrest rate 
 export const importintrestrate = "api/auth/upload-interest-rates"
...
export const filterofirApi = "/api/auth/getFiltersIR"
export const tableofir = "/api/auth/getInterestRateTables_Meb_Ind";

export const minimumaxir = "/api/auth/getInterestRateGraphDataMin_max_val_Meb_Ind";

export const intretrateir = "/api/auth/getInterestRateGraphDataMin_max_val_Meb_Ind";

export const garph56ir = "/api/auth/get_EntityType_WIRR_5_6";

export const graphSingleAllqauter = "/api/auth/get_single_data_all_qauters"
...
export const periodlistqauter  = "api/auth/period/order/list";