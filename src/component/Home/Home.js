...
const Home = () => {
  ...
  const menuHomrItems = [
    {
      ...
      description:
        "Data on Microfinance operations of all Regulated Entities (REs) across the country on a monthly Frequency.",
    ...
    },
    {
      title: "MFIN Members",
      description:
        "Data on Microfinance operations of all MFIN member NBFC-MFIs and Other RE's across the country on a quarterly Frequency.",
    ...
    },
    {
      title: "Benchmarks",
      description:
        "Comparison of key ratios across different peer groups & different size categories.",
    ...
    },
    {
      title: "DRI",
      description:
        "District-level assessment of risk parameters for microfinance operations populated on maps.",
      link: "/dri-states",
    ...
    },
    {
      title: "DRI Pincode",
      description:
        "District-level assessment of risk parameters for microfinance operations populated on Maps and PIN code-level GLPs.",
      link: "/dri-pincode",
      icon: <i className="bi bi-map"></i>,
      checked: true,
    },
...

    {
      ...
      description:
        "Contact details of key personnel in MFIN Member and Associate Institutions.",
      link: "/contacts",
    ...
    },
    {
      title: "Publication",
      description:
        "Micrometer & Micromirror – quarterly publications providing insights on operational & financial parameters of mF operations in India",
    ...
    },
    {
      title: "Admin Account",
      description:
        "Manage admin accounts and assign roles to newly added profiles of users.",
      link: "/adminUsers",
    ...
    },
    {
      title: "Import CSV",
      description:
        "Upload and replace data for various databases using comma-separated values (CSV) files.",
      link: "import-csv",
  ...
  const resCompareMenu = menuHomrItems.map((el1) => ({
    ...
    link: el1.link,
    icon: el1.icon,
    match: userRoleInfo.some(
      (el2) => (el1.title === el2.key) & (el2.checked === true)
    ),
  }));
        ...
        <Grid xs={12} sm={12} md={12}>
          <div class="ag-format-container">
            <div class="ag-courses_box">
              ...
              <div class="ag-courses_item">
                <Link
                  to="https://dataweb.akosmdtech.com/Draft_User_Manual_for_Datahub_2023.pdf"
                  target="_blank"
                ...
                >
                  ...
                  <div class="ag-courses-item_title">
                    <h3>Datahub user guide</h3>
                  </div>
                  <div class="ag-courses-item_date-box">
                    <p>
                      Explore documentation to effortlessly navigate Datahub
