      ...
      setFilterOptions(function (prev) {
        return {
          ...
          regionalHeads:
            response.data &&
              response.data.filters &&
              response.data.filters.regional_heads
              ? response.data.filters.regional_heads
              : prev.regionalHeads,
        };
      });
  ...
  const handleViewClick = (row) => {
    navigate("/view-content", {
      state: {
        ...
        listState: {
          filters,
          currentPage: currentPage,   // DataTable page
        },
      },
    });
