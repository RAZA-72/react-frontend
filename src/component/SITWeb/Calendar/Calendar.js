...
const downloadCsvTemplate = () => {
  ...
  link.href = "/csv_format/tbl_SI_tracker_activity_planner.csv"; // ✅ FIX
  link.download = "tbl_SI_tracker_activity_planner.csv";
  ...
  downloadCsvTemplate={downloadCsvTemplate} // ✅ NEW
