...
const SCMList = () => {
  ...
  useEffect(() => {
    if (isInternalNav.current) {
      ...
      return; // ⛔ stop rehydrating from URL
    }
...
//     if (filters.mid) params.mid = filters.mid;
//     if (filters.regional_head) params.regional_head = filters.regional_head;

//     params.page = 1; // reset page on new filter
...
//                         status,
//                         mid: filters.mid || "",
//                         regional_head: filters.regional_head || "",
//                         page,
//                       });
//                     }}
//                     highlightOnHover
