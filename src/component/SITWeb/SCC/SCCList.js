...
//       console.log("SCC Filtered Data:", statusFilteredData);
//       setData(statusFilteredData);
//     } catch (error) {
//       console.error("Error fetching data:", error);
...
//     const wb = XLSX.utils.book_new();
//     XLSX.utils.book_append_sheet(wb, ws, "SCC");

//     const randomNum = Math.floor(Math.random() * 9000) + 1000;
//     const timestamp = new Date().toISOString().slice(0, 10).replace(/-/g, "");
//     const filename = `SCC_${timestamp}_${randomNum}.xlsx`;
...
//     {
//       name: "Meeting Place",
//       selector: (row) => row.meeting_place,
//       sortable: true,
//       width: "150px",
//       minWidth: "150px",
//     },
...
//                         No SCC meetings found. Try adjusting your filters.
//                       </Typography>
//                     }
//                     customStyles={{
//                       table: {
