        ...
        if (field.name === "districts") {
          ...
          const handleKeyDown = (e) => {
            ...
            if (/^[a-z0-9]$/i.test(e.key)) {
              ...
              const matchingDistricts = (filteredDistricts || []).filter(
                (district) => {
                  return (
                    district &&
            ...
            <div className="row p-0 g-3">
              ...
              <div className="col-md-4">
                ...
                >
                  ...
                  <option value="VSCM">
                    VSCM (Virtual State Chapter Meeting)
                  </option>
                  <option value="SCC">
              ...
              {activityFieldsMap[formData.activity_type] &&
                activityFieldsMap[formData.activity_type]
                  .filter((field) => {
                    ...
                    if (
                      (formData.activity_type === "DFM" ||
                        formData.activity_type === "SKM" ||
                        formData.activity_type === "SCM" ||
                        formData.activity_type === "SCC") &&
                      field.name === "placeOfMeeting"
                    ) {
                      return formData.dynamicFields.mode === "Physical";
                    }
                    if (
                      formData.activity_type === "SKM" &&
                      field.name === "personMeet"
                    ) {
                      return formData.dynamicFields.mode === "Physical";
                    }
