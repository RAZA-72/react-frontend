...
import OtherRE from "../Micrometer/OtherRE.js";
...
const styles = (theme) => ({
  ...
  appBar: {
    ...
    background:
      "linear-gradient(52deg, #2b60ad 14.87%, #39b1ac 86.11%) !important", // Added gradient
...
const INACTIVITY_TIMEOUT = 1800000; // 30 minute 1800000
...
class MiniDrawer extends React.Component {
    ...
    if (result) {
      try {
        ...
        if (
          ...
          ["Alok Misra", "Rama Kamaraju", "Sushrut Pandey"].includes(userName)
        ) {
        ...
        await axios
          .get(`${BaseUrl}/api/auth/loginLogout?user_id=${user_id}`, {
            headers: authHeaders(),
          })
          .then((response) => {
            localStorage.setItem("access_token", "");
  ...
  render() {
    ...
    const res = RolePermissionList.map((el1) => ({
      ...
      match: this.state.userRole.some(
        (el2) => (el1.linkName === el2.linkName) & (el2.checked === true)
      ),
    }));
    return (
      <div className={classes.root}>
        ...
        >
          <Toolbar disableGutters={true}>
            ...
            <Typography variant="h6" style={{ color: "#fff" }} color="white">
              <img
                className="logo-img"
                src="../../../../MFIN_new_logo.png"
                sx={{ mt: 5 }}
              ></img>
            </Typography>
            <Typography
              ...
              >
                ...
                >
                  <Link to="#" style={{ color: "red", textDecoration: "none" }}>
                    <b>
                      <i>
                        Hi {this.state.userName + "," + this.state.MFI_Name}
                      </i>
                    </b>
                  </Link>
                </MenuItem>
          ...
          <Routes>
            {res.map((val) => {
              return (
                <>
                  {val.match === true ? (
                    <Route path={val.linkName} element={val.componentName} />
                  ) : (
            ...
            <Route
              path="/custom-historical-glp-report"
              element={<CustomHistoricalGLP />}
            />
            <Route
              path="/custom-par-analysis-report"
              element={<CustomPARAnalysis />}
            />
            <Route
              path="/custom-dpd-bucket-report"
              element={<CustomDPDBucket />}
            />
            <Route
              path="/custom-disbursement-amount-report"
              element={<CustomDisbursementAmount />}
            />
            <Route
              path="/custom-disbursement-account-report"
              element={<CustomDisbursementAccount />}
            />
            <Route
              path="/custom-universe-portfolio-top-states-report"
              element={<CustomUniversePortfolio />}
            />
            <Route
              path="/custom-universe-par-top-states-report"
              element={<CustomUniversePAR />}
            />

            <Route
              path="/micro-finance-universe/glp-trends-growth"
              element={<GlpTrendsGrowth />}
            />
            <Route
              path="/micro-finance-universe/uniuqe-borrowers-account-trends"
              element={<UniqueBorrowersAccountsTrend />}
            />
            <Route
              path="/micro-finance-universe/disbursement-trend"
              element={<DisbursementTrend />}
            />
            <Route
              path="/micro-finance-universe/par-analysis"
              element={<ParAnalysis />}
            />
            <Route
              path="/micro-finance-universe/par-bucket-analysis"
              element={<ParBucketAnalysis />}
            />
            {/* <Route path="/mudra-bank" element={<MBankWise />} /> */}
            {/* Micrometer Routes */}
            <Route
              path="/micrometer/:graphID"
              element={<OverviewGraphDetails />}
            />
            ...
            />
            <Route
              path="/datapublicationcard"
              element={<DataPublicationCard />}
            />
            <Route
              path="/micrometerresource"
              element={<MicrometerResource />}
            />
            <Route
              path="/micromirrorresource"
              element={<MicromirrorResource />}
            />

            <Route path="/micrometer" element={<Micrometer />} />
            <Route path="/other-res" element={<OtherRE />} />

            <Route
              path="/micromatterresource"
              element={<MicromatterResource />}
            />
            <Route
              path="/otherpublicationsresource"
              element={<OtherpublicationsResource />}
            />
            ...
            <Route
              ...
              element={<ChangePasswordFormUpdate />}
            />
